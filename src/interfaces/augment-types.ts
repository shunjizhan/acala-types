...
import type { AsOriginId, AtLeast64BitUnsigned, OracleKey, OracleValue, RelayChainBlockNumberOf, StableAssetPoolId } from '@acala-network/types/interfaces/runtime';
