...
- `import '@acala-network/api-augment'` - applies acala types and endpoint augmentation
- `import '@acala-network/api-augment/karura'` - applies karura types and endpoint augmentation
- `import '@acala-network/api-augment/mandala'` - applies mandala Alpha types and endpoint augmentation
